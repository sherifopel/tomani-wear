...
import { NEW_IN_PRODUCTS_QUERY } from '@/sanity/queries'
...
export default async function FeaturedProducts() {
  const sanityProducts: SanityProduct[] = await client.fetch(NEW_IN_PRODUCTS_QUERY)
    ...
    >
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="mb-3 md:mb-8 relative flex items-center justify-between">
          <h2 className="text-[28px] font-light ">New Arrivals</h2>
        </div>
