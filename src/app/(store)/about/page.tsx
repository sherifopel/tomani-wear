...
export default function AboutPage() {
  return (
    <div className="max-w-2xl mx-auto px-6 py-14 md:py-20">
      <p className="text-[10px]  text-gray-500 mb-3">Tomanni</p>
      <h1 className="text-2xl font-semibold tracking-tight mb-12">Our Story</h1>

      <section className="mb-12">
        <h2 className="text-[10px]  text-gray-500 mb-5">Mission</h2>
      ...
      <section>
        <h2 className="text-[10px]  text-gray-500 mb-5">Vision</h2>
        <p className="text-sm text-gray-600 leading-loose">
