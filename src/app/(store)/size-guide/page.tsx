        ...
        <thead>
          <tr className="border-b border-gray-100 bg-gray-50">
            {headers.map((h) => (
              <th
                key={h}
                className="px-4 py-3 text-left text-[10px]  text-gray-500 font-normal"
              >
                {h}
              </th>
            ))}
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-14 md:py-20">
      ...
      <section className="mb-12">
        <h2 className="text-[10px]  text-gray-500 mb-5">Tops & T-Shirts</h2>
        <Table
      ...
      <section>
        <h2 className="text-[10px]  text-gray-500 mb-5">Pants</h2>
        <Table
