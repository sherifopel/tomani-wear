  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-14 md:py-20">
      ...
      <section className="mb-10">
        <h2 className="text-[10px] uppercase tracking-widest text-gray-400 mb-5">Shipping</h2>
      ...
      {/* ── Returns ── */}
      <section className="mb-10">
        <h2 className="text-[10px] uppercase tracking-widest text-gray-400 mb-5">Returns</h2>
