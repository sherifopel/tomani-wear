...
export function HeroFocalPreview(props: ObjectInputProps) {
  ...
  // Default to 'video' mode if a video is already uploaded, else 'images'
  ...
  return (
    <div style={{ fontFamily: 'sans-serif', color: '#1a1a1a' }}>
      ...
      {/* ── Mode toggle: Still Images / Video ── */}
      ...
      {mediaMode === 'video' && videoMember && videoMember.kind === 'field' && (
        <div>
          ...
          {/* Video crop preview — shows the video cropped at each device size */}
          {hasVideo && videoCdnUrl && (
            <div style={{ marginTop: 24 }}>
              ...
              <div style={{ marginTop: 16, marginBottom: 12 }}>
                ...
                <input type="range" min={0} max={100} step={5} value={displayY}
              ...
              {showXSlider && (
                <div style={{ marginBottom: 12 }}>
                  ...
                  <input type="range" min={0} max={100} step={5} value={displayX}
              ...
              {hasPendingChanges && (
                <div style={{ display: 'flex', gap: 8, marginTop: 8 }}>
                  <button type="button" onClick={handleSaveForDevice}
                  ...
                  <button type="button" onClick={handleSaveForAll}
